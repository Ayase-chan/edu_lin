<template>
  <div class="login box">
    ...
    <div class="login">
      ...
      <div class="login_box">
        <div class="title">
          <span @click="s1" :class="s">密码登录</span>
          <span @click="s2" :class="s">短信登录</span>
        </div>
        <div class="inp" v-show="inp1">
        ...
        <div class="inp" v-show="inp2">
          ...
          <button class="login_btn" @click="login_2">登录</button>
...
export default {
  ...
  methods: {
    ...
    login_2() {
      if (this.flag){
        this.$axios({
          url: this.$settings.HOST + "user/login_2/",
          method: 'post',
          data: {
            phone: this.phone,
            code: this.code,
...
.login_box .title .s1:nth-of-type(1) {
  color: #4a4a4a;
  border-bottom: 2px solid #84cc39;
}

.login_box .title .s2:nth-of-type(2) {
  color: #4a4a4a;
  border-bottom: 2px solid #84cc39;
}
