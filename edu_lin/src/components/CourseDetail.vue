        ...
        <div class="main">
            <div class="course-info">
                ...
                <div class="wrap-right">
                    ...
                    <p class="data">{{ course.students }}人在学&nbsp;&nbsp;&nbsp;&nbsp;课程总时长：{{ course.pub_lessons }}课时/{{ course.lessons }}小时&nbsp;&nbsp;&nbsp;&nbsp;难度：初级</p>
                    <div class="sale-time" v-if="course.discount_name">
                        <p class="sale-type">{{ course.discount_name }}</p>
                        <p class="expire" v-if="course.active_time">距离结束：仅剩 {{parseInt(course.active_time/(24*3600))}}天 {{parseInt(course.active_time/3600%24)}}小时 {{parseInt(course.active_time/60%60)}}分 <span class="second">{{parseInt(course.active_time%60)}}</span> 秒</p>
                    </div>
                ...
                <div class="course-tab-list">
                    ...
                    <div class="tab-item" v-if="tabIndex==2">
                        <div class="tab-item-title">
                            ...
                            <p class="chapter-length">共8章 {{ course.lessons }}个课时</p>
                        </div>
                        <div class="chapter-item" v-for="cha in chapter_list">
                            <p class="chapter-title"><img src="/static/image/12.png" alt="">第{{ cha['chapter'] }}章·{{cha.name}}</p>
                            <ul class="lesson-list" v-for="(i, index) in cha.coursesections" :key="index">
                                <li class="lesson-item">
                                    <p class="name"><span class="index">{{ cha['chapter'] }}-{{ index+1 }}</span>{{i.name}}<span class="free" v-if="i.free_trail">免费</span>
                                    </p>
                                    <p class="time">{{ i.duration }}<img src="/static/image/chapter-player.svg"></p>
