        ...
        <div class="cart_info">
            ...
            <div class="cart_table">
                ...
                <div class="cart_course_list">
                    <CartItem v-for="(course, index) in cart_list" :course="course" :key="index" @delete_course="del_cart(key)" @change_select="cart_total_price"  @change_exp="cart_total_price"></CartItem>
                </div>
